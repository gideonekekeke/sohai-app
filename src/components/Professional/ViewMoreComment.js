...
import DisplayComent from "../Gidi/dispalyComent";
...
function ViewMoreComment({ id, postedBy, Time }) {
            ...
            <div className="modal_body">
                ...
                >
                  ...
                  <div style={{ display: "flex", marginLeft: "10px" }}>
                    ...
                    <div style={{ color: "silver", marginLeft: "10px" }}>
                      {" "}
                      {moment(data && data.timer).calendar()};
                    </div>
                  </div>
                </div>
                <CloseIcon
              ...
              {needData.map(({ id, timer, com, createdAt, poster }) => (
                <div>
                  <DisplayComent
                    timer={timer}
                    // timer={moment(naming && naming.Time).calendar()}
                    com={com}
                    createdAt={createdAt}
                    poster={poster}
                  />
